...
const sampleProducts = [
  ...
  // 2. Clutches
  { name: "Evening Mosaic Clutch", category: "Clutches", description: "Radiant geometric clutch with high-contrast triangular panels.", base_price: 84, co2_factor: 2.8, waste_factor: 0.45, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/1.png" },
  { name: "Terra Fold Clutch", category: "Clutches", description: "Elegant envelope fold style in soft ochre and tan leather.", base_price: 88, co2_factor: 3.0, waste_factor: 0.48, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/2.png" },
  { name: "Graphite Zip Wrap", category: "Clutches", description: "Modern charcoal zip-top clutch with dynamic hand-stitched detailing.", base_price: 82, co2_factor: 2.7, waste_factor: 0.42, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/3.png" },
  { name: "Emerald Wristlet", category: "Clutches", description: "Forest green mosaic wristlet with detachable organic cotton strap.", base_price: 86, co2_factor: 2.9, waste_factor: 0.46, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/4.png" },
  { name: "Pebbled Sienna Clutch", category: "Clutches", description: "Textured chestnut brown clutch with soft brass hardware.", base_price: 90, co2_factor: 3.1, waste_factor: 0.50, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/5.png" },
  { name: "Zero Waste Shell Wrap", category: "Clutches", description: "Sleek asymmetric flap clutch in contrasting cream and tan.", base_price: 92, co2_factor: 3.2, waste_factor: 0.52, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/6.png" },
  { name: "Orchid Bloom Clutch", category: "Clutches", description: "Delicate dusty pink and sand floral patchwork clutch.", base_price: 94, co2_factor: 3.3, waste_factor: 0.54, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/CLUTCHES/7.png" },
  ...
  // 5. Keychains
  { name: "Braid Loop Keychain", category: "Keychains", description: "Beautiful braided leather lanyard with circular brass key loop.", base_price: 18, co2_factor: 0.2, waste_factor: 0.04, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/1.png" },
  { name: "Hex Tassel Fob", category: "Keychains", description: "Geometric hexagon tile with hanging soft leather tassels.", base_price: 22, co2_factor: 0.25, waste_factor: 0.05, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/2.png" },
  { name: "Mini Sneaker Charm", category: "Keychains", description: "Adorable miniature sneaker replica made entirely from microscopic offcuts.", base_price: 26, co2_factor: 0.3, waste_factor: 0.06, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/3.png" },
  { name: "Agra Emblem Tag", category: "Keychains", description: "Embossed tree-motif circular tag in warm chestnut brown.", base_price: 20, co2_factor: 0.22, waste_factor: 0.04, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/4.png" },
  { name: "Forest Leaf Charm", category: "Keychains", description: "Hand-cut stylized leaf shape in vibrant olive green leather.", base_price: 19, co2_factor: 0.21, waste_factor: 0.04, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/5.png" },
  { name: "Stark Loop Fob", category: "Keychains", description: "Sleek matte black leather strap with gunmetal black ring.", base_price: 16, co2_factor: 0.18, waste_factor: 0.03, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/6.png" },
  { name: "Dune Trio Charm", category: "Keychains", description: "Stacked three-tone leather pebbles on a reinforced steel cord.", base_price: 24, co2_factor: 0.28, waste_factor: 0.05, image_url: "https://adykwrunnuwgwmbzfsxj.supabase.co/storage/v1/object/public/product-images/Ekokintsugi-Products_categorywise/KEYCHAINS/7.png" },
