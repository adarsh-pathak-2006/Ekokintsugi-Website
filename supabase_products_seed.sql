...
catalog AS (
  ...
  FROM (
    VALUES
      ('Mosaic Sling Bag', 3.8, 0.7, 92, 'mosaic-sling-bag.jpeg', 'Compact crossbody sling with reclaimed hexagon panels and a hands-free everyday profile.', 'Bags'),
      ('Mosaic Structured Tote', 4.6, 0.9, 128, 'mosaic-structured-tote.jpeg', 'Clean-lined shoulder tote with a structured base, double handles, and premium circular leather construction.', 'Bags'),
      ('Mosaic City Backpack', 4.9, 1.0, 136, 'mosaic-city-backpack.jpeg', 'Medium-format backpack built for daily commuting with a mosaic upper and durable black trim.', 'Bags'),
      ('Mosaic Messenger Bag', 4.3, 0.8, 118, 'mosaic-messenger-bag.jpeg', 'Boxy messenger silhouette with flap closure for tablets, notebooks, and on-the-go essentials.', 'Bags'),
      ('Mosaic Weekender Briefcase', 5.2, 1.1, 154, 'mosaic-weekender-briefcase.jpeg', 'Travel-ready briefcase with top handles and detachable strap for work trips and light overnights.', 'Bags'),
      ...
      ('Compact Zip Backpack', 4.4, 0.9, 124, 'compact-zip-backpack.jpeg', 'Slim backpack with front zip pocket, upright silhouette, and easy day-trip capacity.', 'Bags'),
      ('Mosaic Shopper Tote', 4.5, 0.9, 122, 'mosaic-shopper-tote.jpeg', 'Tall shopper tote with elongated handles for workday carry, retail presentation, and weekend movement.', 'Bags'),
      ('Mosaic Crossbody Camera Bag', 3.7, 0.7, 94, 'mosaic-crossbody-camera-bag.jpeg', 'Compact zip crossbody with wide strap and boxy proportions for essentials-first daily use.', 'Bags'),
      ('Mosaic Travel Duffel', 5.8, 1.2, 168, 'mosaic-travel-duffel.jpeg', 'Soft travel duffel with structured ends and generous storage for short stays and carry-on duty.', 'Bags'),
      ('Mosaic Belt Bag', 2.9, 0.5, 74, 'mosaic-belt-bag.jpeg', 'Curved belt bag with front-facing style and lightweight convenience for urban movement.', 'Bags'),
      ('Mosaic Laptop Briefcase', 5.0, 1.0, 148, 'mosaic-laptop-briefcase.jpeg', 'Professional briefcase with top handles, shoulder strap, and space for a laptop and documents.', 'Bags'),
