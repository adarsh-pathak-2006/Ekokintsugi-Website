    ...
    <section id="contact" className="py-32 bg-muted/20 relative">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-24">
          ...
          <h2 className="text-5xl font-serif text-primary md:text-7xl mb-8 font-bold leading-tight">Let's Create <br /><span className="text-accent underline decoration-4 underline-offset-8 transition-all hover:decoration-primary">Together</span></h2>
