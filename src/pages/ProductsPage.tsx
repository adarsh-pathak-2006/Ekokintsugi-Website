      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="text-center mb-20">
          <span className="section-badge mb-4">
            <span className="section-badge-label">EkoKintsugi Products</span>
          </span>
          ...
          <p className="text-xl text-muted-foreground italic max-w-3xl mx-auto">
            Choose a product family first, then explore a focused page for leather backpacks, leather bags, wallets,
            accessories, and distinct men's and women's footwear collections.
          </p>
        </header>
        ...
        <div className="bg-card border border-border/50 p-8 md:p-12 rounded-[2.5rem] shadow-sm mb-20">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            ...
            <div className="bg-primary text-primary-foreground rounded-3xl px-6 py-5 min-w-56">
              ...
              <p className="text-sm opacity-80">Live grouping across leather backpacks, leather bags, wallets, accessories, and separate men's and women's footwear lines.</p>
            </div>
          </div>
        </div>
