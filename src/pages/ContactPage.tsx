    ...
    <div className="py-20 min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <header className="mb-20 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-serif text-primary font-bold mb-6">Partnership Invitation</h1>
        ...
        <div className="bg-primary text-primary-foreground p-12 md:p-20 rounded-[3rem] shadow-strong flex flex-col md:flex-row gap-20 overflow-hidden relative">
          ...
          <div className="flex-1 relative z-10 space-y-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Together, we build the largest India-EU circular footwear ecosystem.</h2>
